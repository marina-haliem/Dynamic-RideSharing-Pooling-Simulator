...
![Overall architecture of the simulator.\label{arch}](Architecture00.pdf){ width=70% }
...
![Code architecture of the simulator. \label{modular}](codeArch1.pdf){ width=70% }
